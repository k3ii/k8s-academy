# Kubernetes Certification Exams: CKAD, CKA, CKS — Current State

Resolves issue #5 (`k3ii/k8s-academy`), sub-issue of the MAP issue #1.

**Research date:** 2026-08-17. Every domain weight below was read out of the current
curriculum PDF in `cncf/curriculum` — none are quoted from memory or from blog posts.
Facts that could not be confirmed from a primary source are marked
**[UNVERIFIED]** inline.
