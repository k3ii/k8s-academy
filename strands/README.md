...
| [`lab-topologies.md`](lab-topologies.md) | The nine named guest layouts at per-node resolution, their addresses, and how one is provisioned, reached and torn down. |
